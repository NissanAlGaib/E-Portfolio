    ...
    <header class="bg-glass border-b border-gray-700 backdrop-blur-lg sticky top-0 z-50">
        <div class="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
            <div class="flex items-center space-x-4">
                <a href="dashboard.php" class="text-2xl font-bold bg-gradient-to-r from-blue-start to-purple-end bg-clip-text text-transparent hover:opacity-80 transition-opacity">
                    Admin Panel
                </a>
            </div>
            <div class="flex items-center space-x-4">
