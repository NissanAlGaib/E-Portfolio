<?php $page_title = 'Manage Achievements';
include '_header.php'; ?>
<section class="max-w-7xl mx-auto p-12">
    ...
    <div id="achievementsPagination"></div>
    ...
    <div id="editAchievementModal" class="hidden fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50">
        <div class="bg-gray-900 border border-gray-700 rounded-lg shadow-2xl p-6 max-w-2xl w-full mx-4">
            <h2 class="text-2xl font-bold text-white mb-4">Edit Achievement</h2>
            <form id="edit-achievement-form" class="space-y-4">
                <input type="hidden" id="edit-achievement-id">
                <input type="hidden" id="edit-achievement-user-id" value="1">

                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="md:col-span-2">
                        <label class="block text-gray-300 mb-2">Achievement Title</label>
                        <input type="text" id="edit-achievement-title" required class="w-full px-4 py-2 bg-dark-bg/80 border border-white/10 rounded-lg text-white focus:outline-none focus:border-blue-500">
                    </div>

                    <div>
                        <label class="block text-gray-300 mb-2">Category</label>
                        <input type="text" id="edit-achievement-category" class="w-full px-4 py-2 bg-dark-bg/80 border border-white/10 rounded-lg text-white focus:outline-none focus:border-blue-500">
                    </div>

                    <div>
                        <label class="block text-gray-300 mb-2">Issuer</label>
                        <input type="text" id="edit-achievement-issuer" class="w-full px-4 py-2 bg-dark-bg/80 border border-white/10 rounded-lg text-white focus:outline-none focus:border-blue-500">
                    </div>

                    <div>
                        <label class="block text-gray-300 mb-2">Date Achieved</label>
                        <input type="date" id="edit-achievement-date" class="w-full px-4 py-2 bg-dark-bg/80 border border-white/10 rounded-lg text-white focus:outline-none focus:border-blue-500">
                    </div>

                    <div>
                        <label class="block text-gray-300 mb-2">Display Order</label>
                        <input type="number" id="edit-achievement-order" min="0" class="w-full px-4 py-2 bg-dark-bg/80 border border-white/10 rounded-lg text-white focus:outline-none focus:border-blue-500">
                    </div>

                    <div class="md:col-span-2">
                        <label class="block text-gray-300 mb-2">Description</label>
                        <textarea id="edit-achievement-description" rows="3" class="w-full px-4 py-2 bg-dark-bg/80 border border-white/10 rounded-lg text-white focus:outline-none focus:border-blue-500"></textarea>
                    </div>
                </div>

                <div class="flex justify-end space-x-3 mt-6">
                    <button type="button" onclick="closeEditAchievementModal()" class="px-6 py-2 bg-gray-700 text-white rounded-lg hover:bg-gray-600 transition">Cancel</button>
                    <button type="submit" class="px-6 py-2 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-lg hover:opacity-90 transition">Update Achievement</button>
                </div>
            </form>
        </div>
    </div>
...
<script src="/E-Portfolio/E-Portfolio/frontend/src/js/admin/ManageAchievements.js"></script>
<script>
