...
function renderEducation(education) {
  ...
  container.innerHTML = education.map(edu => renderEducationCard(edu)).join('');
}
  ...
  return `
    <div class="bg-glass border border-gray-700 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 hover:border-blue-start">
      <div class="flex items-start space-x-6">
        ...
        <div class="flex-grow">
          <h3 class="text-2xl font-bold text-white mb-1">${edu.institution_name}</h3>
          <p class="text-xl text-gray-300 mb-2">${edu.degree}${edu.field_of_study ? ' in ' + edu.field_of_study : ''}</p>
